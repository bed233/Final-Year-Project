...
package com.rhul.fyp.asecav.maxlock.ui.settings;
...
import com.rhul.fyp.asecav.maxlock.preference.ImplementationPreference;
import com.rhul.fyp.asecav.maxlock.ui.SettingsActivity;
import com.rhul.fyp.asecav.maxlock.ui.settings.applist.AppListFragment;
...
import com.rhul.fyp.asecav.maxlock.Common;
import com.rhul.fyp.asecav.maxlock.MLImplementation;
import com.rhul.fyp.asecav.R;
import com.rhul.fyp.asecav.maxlock.preference.ImplementationPreference;
import com.rhul.fyp.asecav.maxlock.ui.SettingsActivity;
import com.rhul.fyp.asecav.maxlock.ui.settings.applist.AppListFragment;
import com.rhul.fyp.asecav.maxlock.ui.settings_new.SettingsUtils;
import com.rhul.fyp.asecav.maxlock.util.KUtil;
        ...
        switch (screen) {
            ...
            case TYPE:
                ...
                if (!fpm.isHardwareDetected()) {
                    if ( SDK_INT >= Build.VERSION_CODES.M) { //09.01.2023 zjac078 Compatibility
                        // with Android 5
                ...
                switch (preference.getKey()) {
                    ...
                    case Common.HIDE_APP_FROM_LAUNCHER:
                        ...
                        if (hideApp.isChecked()) {
                            ...
                            ComponentName componentName = new ComponentName(getActivity(), "com.rhul.fyp.asecav.maxlock.Main");
                    ...
                    case Common.UNINSTALL:
                        if (!((SettingsActivity) getActivity()).isDeviceAdminActive()) {
                            ...
                            uninstall.setData(Uri.parse("package:com.rhul.fyp.asecav.maxlock"));
