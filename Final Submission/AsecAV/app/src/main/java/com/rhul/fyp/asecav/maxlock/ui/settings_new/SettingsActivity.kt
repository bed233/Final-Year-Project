...
import com.rhul.fyp.asecav.maxlock.ui.settings_new.screens.AppListScreen
import com.rhul.fyp.asecav.maxlock.util.*
import java.util.*

class SettingsActivity : AppCompatActivity(),
    AuthenticationSucceededListener, PreferencesAdapter.OnScreenChangeListener {
            ...
            when (preferenceKey) {
                ...
                UNINSTALL -> {
                    if (devicePolicyManager?.isAdminActive(deviceAdmin) != true) {
                        ...
                        uninstall.data = Uri.parse("package:com.rhul.fyp.asecav.maxlock")
