...
class LockScreenTest {
    ...
    private val testPackageName = "com.rhul.fyp.asecav.maxlock.test_package_name"
    ...
    private fun setupAndLaunchActivity(lockingType: String, password: String) {
        ...
        MLPreferences.getPreferencesKeysPerApp(context).edit {
            ...
            putString(testPackageName + Common.APP_KEY_PREFERENCE, util.Util.shaHash(password))
        }
