...
import com.rhul.fyp.asecav.maxlock.ui.actions.ActionsHelper
import com.rhul.fyp.asecav.maxlock.ui.actions.BundleScrubber
import com.rhul.fyp.asecav.maxlock.ui.actions.tasker.TaskerHelper.EVENT_TYPE_EXTRA_KEY
import com.rhul.fyp.asecav.maxlock.ui.actions.tasker.TaskerHelper.EVENT_UNLOCK_ATTEMPT
import com.rhul.fyp.asecav.maxlock.ui.actions.tasker.TaskerHelper.EVENT_UNLOCK_FAILED
import com.rhul.fyp.asecav.maxlock.ui.actions.tasker.TaskerHelper.EVENT_UNLOCK_SUCCESS
import com.rhul.fyp.asecav.maxlock.util.MLPreferences
import com.rhul.fyp.asecav.maxlock.util.NotificationHelper
import com.rhul.fyp.asecav.maxlock.util.Util
import net.dinglisch.android.tasker.TaskerPlugin
import org.json.JSONException
import org.json.JSONObject

const val EXTRA_ATTEMPT_SUCCESSFUL = "com.rhul.fyp.asecav.maxlock.tasker.event.ATTEMPT_SUCCESSFUL"
const val EXTRA_PACKAGE_NAME = "com.rhul.fyp.asecav.maxlock.tasker.event.PACKAGE_NAME"

object TaskerHelper {
    const val EVENT_TYPE_EXTRA_KEY = "com.rhul.fyp.asecav.maxlock.extra.EVENT_TYPE"
...
fun handleActionIntent(context: Context, intent: Intent) {
    ...
    Handler(Looper.getMainLooper()).post({
        ActionsHelper.callAction(extra.getInt(
            ActionsHelper.ACTION_EXTRA_KEY, -1), context)
    })
}
