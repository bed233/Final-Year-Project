...
import com.rhul.fyp.asecav.maxlock.ui.settings.DonateActivity
import com.rhul.fyp.asecav.maxlock.ui.settings_new.implementation.ImplementationDialogPreference
import com.rhul.fyp.asecav.maxlock.ui.settings_new.screens.CustomScreen
import com.rhul.fyp.asecav.maxlock.util.GenericEventLiveData
import com.rhul.fyp.asecav.maxlock.util.application
import com.rhul.fyp.asecav.maxlock.util.applicationName
import com.rhul.fyp.asecav.maxlock.util.prefs
    ...
    override fun onCheckedChanged(preference: TwoStatePreference, holder: PreferencesAdapter.ViewHolder?, checked: Boolean): Boolean {
        when (preference.key) {
            HIDE_APP_FROM_LAUNCHER -> {
                val componentName = ComponentName(application, "com.rhul.fyp.asecav.maxlock.Main")
                if (checked) {
