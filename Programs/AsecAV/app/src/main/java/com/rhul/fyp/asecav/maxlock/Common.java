...
public abstract class Common {
    ...
    public static final String MAXLOCK_PACKAGE_NAME = "com.rhul.fyp.asecav";
    ...
    public static final String PREFERENCE_PROVIDER_AUTHORITY = "com.rhul.fyp.asecav.maxlock.preferences";
