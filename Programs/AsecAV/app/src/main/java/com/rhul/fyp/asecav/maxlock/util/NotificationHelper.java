...
import com.rhul.fyp.asecav.maxlock.ui.NewAppInstalledBroadcastReceiver;
import com.rhul.fyp.asecav.maxlock.ui.actions.ActionActivity;
import com.rhul.fyp.asecav.maxlock.ui.actions.ActionsHelper;

import static com.rhul.fyp.asecav.maxlock.ui.NewAppInstalledBroadcastReceiver.EXTRA_PACKAGE_NAME;
import static com.rhul.fyp.asecav.maxlock.ui.NewAppInstalledBroadcastReceiver.MAXLOCK_ACTION_LOCK_APP;
import static com.rhul.fyp.asecav.maxlock.ui.NewAppInstalledBroadcastReceiver.MAXLOCK_ACTION_NEVER_SHOW_AGAIN;
...
public final class NotificationHelper {
    ...
    public static void postAppInstalledNotification(Context context, String packageName) {
        Intent neverShowAgain = new Intent(NewAppInstalledBroadcastReceiver.MAXLOCK_ACTION_NEVER_SHOW_AGAIN);
        neverShowAgain.setClass(context, NewAppInstalledBroadcastReceiver.class);
        Intent lockApp = new Intent(NewAppInstalledBroadcastReceiver.MAXLOCK_ACTION_LOCK_APP);
        lockApp.setClass(context, NewAppInstalledBroadcastReceiver.class);
        lockApp.putExtra(NewAppInstalledBroadcastReceiver.EXTRA_PACKAGE_NAME, packageName);
